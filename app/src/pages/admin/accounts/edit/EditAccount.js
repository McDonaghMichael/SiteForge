...
export default function EditAccount() {
    ...
    useEffect(() => {
        const res = axios.get(`https://siteforgeapi.mcdonagh.xyz/account/id/${id}`).then((res) => {
            setAccount(res.data);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://siteforgeapi.mcdonagh.xyz/account/edit", account, {
                headers: {
